...
class OpCode {
    ...
    public static inline final GreaterThan = 0x12;
    public static inline final Negate = 0x13;
    public static inline final Not = 0x14;
    public static inline final ConcatString = 0x15;

    public static inline final Load = 0x16;
    public static inline final Store = 0x17;
    public static inline final LoadBuiltIn = 0x18;

    public static inline final Call = 0x19;
    public static inline final Return = 0x1a;

    public static inline final Array = 0x1b;
