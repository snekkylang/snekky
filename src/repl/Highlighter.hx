    ...
    public static function highlight(code:String) {
        ...
        while (true) {
            ...
            final highlighted = switch (token.type) {
                ...
                case TokenType.If | TokenType.Else | TokenType.While | TokenType.Break | TokenType.Continue | TokenType.Return 
                    | TokenType.For | TokenType.When | TokenType.Import | TokenType.Try | TokenType.Catch:
